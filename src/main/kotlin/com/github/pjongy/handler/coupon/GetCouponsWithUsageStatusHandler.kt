      ...
      couponsWithUsageStatus = couponWithUsages.map {
        CouponWithUsageStatus(
          coupon = Coupon(
            ...
            issuingCondition = gson.fromJson(it.coupon.issuingCondition, Condition::class.java),
            usingCondition = gson.fromJson(it.coupon.usingCondition, Condition::class.java),
          ),
